...
export class Backend implements backendInterface {
    ...
    async createDoctor(arg0: Doctor): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async getAdmissionsByDate(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAdmissionsByDate();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAppointmentsByPatient(arg0: bigint): Promise<Array<Appointment>> {
        if (this.processError) {
            try {
    ...
    async getDashboardTotals(arg0: string): Promise<DashboardTotals> {
        if (this.processError) {
            try {
                const result = await this.actor.getDashboardTotals(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDiseaseFrequency(): Promise<Array<[string, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDiseaseFrequency();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getDoctorAppointmentCounts(): Promise<Array<[bigint, bigint]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDoctorAppointmentCounts();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async readDoctor(arg0: bigint): Promise<Doctor> {
        if (this.processError) {
            try {
                const result = await this.actor.readDoctor(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async readPatient(arg0: bigint): Promise<Patient> {
        if (this.processError) {
            try {
                const result = await this.actor.readPatient(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateDoctor(arg0: Doctor): Promise<void> {
        if (this.processError) {
            try {
